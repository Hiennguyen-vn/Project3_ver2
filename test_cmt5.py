"""
Test RL-CMTEA-SMP-DaS trên CMT5.
"""
...
def run_cmt5_experiment(num_generations=100, sub_pop=100, num_runs=30):
    """
    Chạy thực nghiệm CMT5.
    """
    print("=" * 60)
    print("TEST RL-CMTEA-SMP-DaS TRÊN CMT5")
    print("=" * 60)
...
if __name__ == "__main__":
    # Paper budget: 1000*D*T = 1000*100*2 = 200000 FES total
    # With pop=100, 4*pop evals/gen -> 500 generations
    results = run_cmt5_experiment(num_generations=500, sub_pop=100, num_runs=30)
