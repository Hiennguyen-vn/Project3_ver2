"""
Test RL-CMTEA-DaS trên CMT7-CMT9 (các bài toán còn lại) với paper budget (200K FES).
"""
...
def main():
    print("="*60)
    print("CMT7-CMT9 Experiments with DaS KT")
